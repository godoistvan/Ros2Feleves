#!/usr/bin/env python3
# Minimal Koch snowflake drawer for turtlesim.
# Terminal 1: ros2 run turtlesim turtlesim_node
# Terminal 2: ros2 run <your_pkg_name> <your_node_name> --ros-args -p order:=3
...
class KochSnowflake(Node):
    ...
    def _sync_call(self, client, request):
        ...
        return None # rclpy not ok or future didn't complete successfully
